...
$.widget("mobile.slider", $.mobile.slider, {
    ...
    _create: function() {
        if (this.options.vertical) {
            ...
            this.slider.attr("style", "width:5px !important; margin: 0 auto 20px !important; height:"+this.options.height+"px !important;")
            $(this.control).detach()
...
// invert min and max
            ...
            //this.handle.css("margin-left", "-20px");
            this.handle.addClass("ui-slider-track-vertical-button");
